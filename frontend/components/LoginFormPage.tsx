...
function LoginFormPage({ onClientLogin, onAdminLogin }: LoginFormPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const user = await authService.login(email, password, loginType);
      ...
      setError(e.message || "Failed to authenticate. Please try again later.");
    } finally {
